...
# Message templates
SERVER_MESSAGES = {
    'server_start': 'math MCP server starting on port {port}',
    'server_started': 'math MCP server started successfully on port {port}',
...
# Generated by McpServerGen.py on 2025-07-29 14:58:05
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
math_PORT = int(os.getenv('MCP_MATH_PORT', 7905))
math_PROTOCOL = os.getenv('MCP_MATH_PROTOCOL', 'sse')
