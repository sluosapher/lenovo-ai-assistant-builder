# Build script for Google_hotel MCP Server

Write-Host "Building Google_hotel MCP Server..." -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Executable created at: dist\google_hotel-mcp-server.exe" -ForegroundColor Green
